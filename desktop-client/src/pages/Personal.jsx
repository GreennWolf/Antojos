...
import { Roles } from '../components/PersonalTab/Roles';
import { Empleados } from '../components/PersonalTab/Empleados';
...
export const Personal = () => {
  ...
  const tabs = [
    { 
      id: 'empleados', 
      label: 'Empleados', 
      privilege: { action: 'READ', resource: 'EMPLEADOS' },  // Cambiado de CUENTA a EMPLEADOS
      component: <Empleados /> 
    },
    { 
      id: 'roles', 
      label: 'Roles', 
      privilege: { action: 'READ', resource: 'ROLES' },
      component: <div className="p-4"><Roles/></div> 
    },
    { 
      id: 'horarios', 
      label: 'Horarios', 
      privilege: { action: 'READ', resource: 'HORARIOS' },
      component: <div className="p-4">Componente de Horarios</div> 
    }
  ];
  ...
  return (
    <div className="p-4">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-xl font-semibold text-[#727D73]">Personal</h1>
      </div>
